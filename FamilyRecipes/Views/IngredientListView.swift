...
struct IngredientListView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        IngredientListView(ingredients: [IngredientViewModel(ingredient: IngredientMeasurement(id: UUID(), unit: Unit(id: UUID(), name: "unit"), ingredient: Ingredient(id: UUID(), name: "Eggs", description: "Fresh Organic Eggs"), amount: 2))])
    }
}
